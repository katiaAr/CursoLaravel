...
class DocenteGrupoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('docentes_grupos.index')->with('success', 'Docente Grupo creado exitosamente');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('docentes_grupos.index')->with('success', 'Docente Grupo modificado exitosamente');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('docentes_grupos.index')->with('success', 'Docente Grupo eliminado exitosamente');
    }
}
